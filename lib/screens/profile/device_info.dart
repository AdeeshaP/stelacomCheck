import 'package:stelacom_check/controllers/device_controller.dart';
...
class _DeviceInfoScreenState extends State<DeviceInfoScreen> {
  ...
  late DeviceInfoController deviceController;

  @override
  void initState() {
    super.initState();
    // Initialize GetX controller
    deviceController = Get.put(DeviceInfoController());
    getSharedPrefs();
    _initPlatformState();
  }
  ...
  @override
  void dispose() {
    // Optional: Remove controller when screen is disposed
  ...
  Future<void> _initPlatformState() async {
    try {
      ...
      // CHANGED: Use controller instead of setState
      deviceController.updateDeviceData(_readAndroidGeneraldData(androidInfo));
    } catch (e) {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: Responsive.isMobileSmall(context) ||
              ...
              ? 40
              : Responsive.isTabletPortrait(context) ? 80 : 90,
            ...
            children: [
              SizedBox(
                width: Responsive.isMobileSmall(context) ||
                        ...
                        Responsive.isMobileLarge(context)
                    ? 90.0
                    : Responsive.isTabletPortrait(context) ? 150 : 170,
                height: Responsive.isMobileSmall(context) ||
                        Responsive.isMobileMedium(context) ||
                        Responsive.isMobileLarge(context)
                    ? 40.0
                    : Responsive.isTabletPortrait(context) ? 120 : 100,
                child: Image.asset(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: Responsive.isMobileSmall(context)
                            ...
                            : Responsive.isMobileMedium(context) ||
                                    Responsive.isMobileLarge(context)
                                ? 17
                                : Responsive.isTabletPortrait(context) ? 25 : 25,
                      ),
                    ),
                  );
                }).toList();
        ...
        // CHANGED: Wrap body with Obx to observe device data changes
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard(
                    ...
                    items: {
                      'Device Id':
                          deviceController.deviceDataValue['Device Id'] ?? 'N/A',
                      'Device Brand':
                          deviceController.deviceDataValue['Device Brand'] ??
                              'N/A',
                      'Device':
                          deviceController.deviceDataValue['Device'] ?? 'N/A',
                      'Device Model':
                          deviceController.deviceDataValue['Device Model'] ??
                              'N/A',
                      'Product':
                          deviceController.deviceDataValue['Product'] ?? 'N/A',
                    },
                  ),
                  SizedBox(height: 10),
                  _buildInfoCard(
                    ...
                    items: {
                      'Android Version':
                          deviceController.deviceDataValue['Android Version'] ??
                              'N/A',
                      'API Level':
                          deviceController.deviceDataValue['API Level']
                                  ?.toString() ??
                              'N/A',
                    },
                  ),
                  ...
                  _buildInfoCard(
                    ...
                    items: {
                      'Device Width (px)':
                          '${physicalWidth.toStringAsFixed(0)} px',
                      'Device Height (px)':
                  ...
                  Icon(
                    ...
                    size: Responsive.isMobileSmall(context)
                        ...
                        : Responsive.isMobileMedium(context) ||
                                Responsive.isMobileLarge(context)
                            ? 25
                            : Responsive.isTabletPortrait(context) ? 35 : 35,
                  ),
                  SizedBox(width: 12),
                  Text(
                    title,
