...
class _IMEIScannerScreenState extends State<IMEIScannerScreen>
  ...
  // void _showUnexpectedIMEI(String imei) {
  //   ScaffoldMessenger.of(context).showSnackBar(
  //     SnackBar(
  //       content: Row(
  //         children: [
  ...
  //           Expanded(
  //             child: Text(
  //               'IMEI not expected for this transfer order: ${imei}',
  ...
  // void _removeScannedIMEI(String imei) {
  //   setState(() {
  //     scannedIMEIs.remove(imei);
  //     scannedSet.remove(imei);
  //     if (!isScanning && scannedIMEIs.length < widget.actualQuantity) {
  //       isScanning = true;
  //       _isProcessing = false;
  //     }
  //   });
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Need to scan ${widget.actualQuantity} received items',
                  style: TextStyle(
          ...
          //                       ),
          //                       IconButton(
          //                         onPressed: () => _removeScannedIMEI(imei),
