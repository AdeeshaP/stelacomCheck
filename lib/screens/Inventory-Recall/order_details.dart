...
import 'package:stelacom_check/screens/Inventory-Recall/recall_process_screen.dart';
...
class RecallOrderDetailsScreen extends StatefulWidget {
  final RecallTransferOrder order;
  final int index;

  const RecallOrderDetailsScreen({
    super.key,
    required this.order,
    required this.index,
  });
  ...
  @override
  State<RecallOrderDetailsScreen> createState() =>
      _RecallOrderDetailsScreenState();
}

class _RecallOrderDetailsScreenState extends State<RecallOrderDetailsScreen> {
  ...
  // Add these state variables to your _RecallOrderDetailsScreenState class
  ...
  bool shouldShowVerificationDetails() {
    return widget.order.status.toLowerCase() == 'sent' ||
        widget.order.status.toLowerCase() == 'partial';
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (shouldShowVerificationDetails()) SizedBox(height: 5),
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => RecallProcessScreen(
                                  order: widget.order,
                                  index: widget.index,
                                  userObj: userObj,
                                ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                widget.order.status.toLowerCase() == 'sent'
                                    ? 'All the items in this transfer order have already been verified and dispatched to the main warehouse.'
                                    : widget.order.status.toLowerCase() ==
                                          'partial'
                                    ? 'Certain items in this transfer order have already been verified and dispatched to the main warehouse.'
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: item.serialized && item.quantity > 1
                                        ? 0
                                        : 3,
                                  ),
                                  if (item.serialized)
