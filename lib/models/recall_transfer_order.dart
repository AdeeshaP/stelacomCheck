class RecallTransferOrderitem {
  ...
  factory RecallTransferOrderitem.fromJson(Map<String, dynamic> json) {
    return RecallTransferOrderitem(
...
class RecallTransferOrder {
  final String transferId;
  final String fromLocation;
  final String toLocation;
  final String assignedDate;
  final String status;
  final List<RecallTransferOrderitem> items;
  ...
  factory RecallTransferOrder.fromJson(Map<String, dynamic> json) {
    return RecallTransferOrder(
      ...
      items: (json['items'] as List)
          .map((item) => RecallTransferOrderitem.fromJson(item))
          .toList(),
    );
  }
